...
<section class="header">
    ...
    <div class="text-center">
        <h2 class="medium text-white mt-3">Layanan Report Civitas</h2>
...
{{-- <a class="nav-link ml-3 text-white" href="{{ route('pekat.logout') }}"
                                style="text-decoration: underline">{{ Auth::guard('civitas')->user()->name }}</a> --}}